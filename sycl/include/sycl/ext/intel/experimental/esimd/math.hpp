...
ESIMD_NODEBUG ESIMD_INLINE typename sycl::detail::enable_if_t<
    std::is_integral<typename simd_view<BaseTy, RegionTy>::element_type>::value &&
...
/// @param src0 input simd_view object of size 1.
/// @return scalar number of the first bit set starting from the least significant bit.
template <typename BaseTy, typename RegionTy>
ESIMD_NODEBUG ESIMD_INLINE typename sycl::detail::enable_if_t<
    std::is_integral<typename simd_view<BaseTy, RegionTy>::element_type>::value &&
    (sizeof(typename simd_view<BaseTy, RegionTy>::element_type) == 4) &&
...
/// @param src0 input simd_view object of size 1.
/// @return scalar number of the first bit set starting from the most significant bit.
template <typename BaseTy, typename RegionTy>
ESIMD_NODEBUG ESIMD_INLINE typename sycl::detail::enable_if_t<
    std::is_integral<typename simd_view<BaseTy, RegionTy>::element_type>::value &&
    (sizeof(typename simd_view<BaseTy, RegionTy>::element_type) == 4) &&
